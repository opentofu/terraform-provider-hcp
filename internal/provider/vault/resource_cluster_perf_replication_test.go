...
func performanceReplicationSteps(t *testing.T, in *inputT) []resource.TestStep {
	return []resource.TestStep{
		{
			Config: testhelpers.TestConfig(setTestAccPerformanceReplicationE2E(t, "", in)),
		...
		},
		{
			...
			Config: testhelpers.TestConfig(setTestAccPerformanceReplicationE2E(t, `
		...
		},
		{
			...
			Check: resource.ComposeTestCheckFunc(
				...
				testhelpers.CheckFullURL(primaryVaultResourceName, "vault_private_endpoint_url", ""),
		...
		},
		{
			...
			Check: resource.ComposeTestCheckFunc(
				...
				testhelpers.CheckFullURL(secondaryVaultResourceName, "vault_private_endpoint_url", ""),
