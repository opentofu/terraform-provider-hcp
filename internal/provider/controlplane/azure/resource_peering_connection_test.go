...
func TestAccAzurePeeringConnection(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		PreCheck:          func() { testhelpers.PreCheck(t, map[string]bool{"aws": false, "azure": true}) },
		...
		Steps: []resource.TestStep{
			{
				// Tests create
				Config: testhelpers.TestConfig(testAccAzurePeeringConfig),
				Check: resource.ComposeTestCheckFunc(
					...
					testhelpers.CheckLinkFromState(resourceName, "hvn_link", uniqueAzurePeeringTestID, links.HvnResourceType, resourceName),
					...
					testhelpers.CheckLinkFromState(resourceName, "self_link", uniqueAzurePeeringTestID, links.PeeringResourceType, "hcp_hvn.test"),
...
func testAccCheckAzurePeeringExists(name string) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		...
		hvnLink, err := links.BuildLinkFromURL(hvnUrn, links.HvnResourceType, client.Config.OrganizationID)
		if err != nil {
