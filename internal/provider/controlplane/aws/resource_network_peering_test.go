...
func TestAccAwsPeering(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testhelpers.TestConfig(testAccAwsPeeringConfig),
				Check: resource.ComposeTestCheckFunc(
					...
					testhelpers.CheckLinkFromState(resourceName, "self_link", hvnPeeringUniqueAWSName, links.PeeringResourceType, "hcp_hvn.test"),
				),
			},
