...
func TestAccTGWAttachment(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testhelpers.TestConfig(testAccTGWAttachmentConfig),
				Check: resource.ComposeTestCheckFunc(
					...
					testhelpers.CheckLinkFromState(resourceName, "self_link", tgwAttUniqueAWSName, links.TgwAttachmentResourceType, "hcp_hvn.test"),
				),
			},
...
func testAccCheckTGWAttachmentExists(name string) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		...
		tgwAttLink, err := links.BuildLinkFromURL(id, links.TgwAttachmentResourceType, client.Config.OrganizationID)
		if err != nil {
