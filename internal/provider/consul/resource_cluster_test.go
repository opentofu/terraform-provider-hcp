...
func TestAccConsulCluster(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config:      testhelpers.TestConfig(setTestAccConsulClusterConfig(createConsulClusterCIDRExceeded)),
				PlanOnly:    true,
				ExpectError: regexp.MustCompile(`Too many ip_allowlist blocks`),
			},
			// Tests create
			{
				Config: testhelpers.TestConfig(setTestAccConsulClusterConfig(consulCluster)),
				Check: resource.ComposeTestCheckFunc(
					...
					testhelpers.CheckFullURL(resourceName, "consul_private_endpoint_url", ""),
			...
			// Tests update
			{
				Config: testhelpers.TestConfig(setTestAccConsulClusterConfig(updatedConsulCluster)),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckConsulClusterExists(resourceName),
