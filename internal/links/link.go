...
const (
	// links.ConsulClusterResourceType is the resource type of a Consul cluster
	...
	// links.HVNRouteResourceType is the resource type of an HVN route
	...
	// links.VaultClusterResourceType is the resource type of a Vault cluster
